...
4. GET: Получить по существующему пользователя по id
5. GET: Получить по несуществующему пользователя по id
6. GET: Неверный формат id . Например alphanumeric формат по id
7. DELETE: Удаление существующего пользователя 
